                    ...
                    $content .= "<script>
                                 $( document ).ready(function() {
                                    var text = '<h1> TÉRMINOS Y CONDICIONES </h1>';
    	                                text += ".'"'."<p align = 'justify'> Los presentes términos y condiciones, regulan el acceso y uso de los usuarios a la plataforma Webcursos de la Universidad Adolfo Ibáñez <a href='http://webcursos.uai.cl'>https://webcursos.uai.cl</a>.</p>".'";'.
                                        "text += ".'"'."<p align = 'justify'> Los Usuarios deberán de leer y aceptar estas condiciones para usar todos los servicios e informaciones que se facilitan desde la plataforma. El mero acceso y/o utilización de Webcursos, de todos o parte de sus contenidos y/o servicios significa la plena aceptación de las presentes condiciones generales de uso. Para efectos de los presentes términos y condiciones se entenderá por:</p>".'";'.
                                        "text += ".'"'."<ol type = 'a'>".'";'.
                                        "text += ".'"'."<li align = 'justify'> Material de Libre Acceso: Son todas aquellas obras que no requieren de alguna suscripción o pago, dentro de estas podemos encontrar artículos de investigación científica de revistas especializadas u otras obras que no requieren de un permiso del autor, de la institución que genere la obra o de la editorial que la publique, para su reproducción.</li>".'";'.
                                        ...
                                        "text += ".'"'."<ol type = '1' >".'";'.
                                        "text += ".'"'."<li align = 'justify'> Todo documento o material que sea publicado en Webcursos, deberá dar total cumplimiento a la Ley 17.336 sobre Propiedad Intelectual, de modo que no se incurra en ningún tipo de violación al Derecho de Autor que protege dicha norma legal, ni se transgredan otros derechos consagrados en esta u otras leyes, situación que deberá ser prevista y revisada por el docente, alumno o persona que provea de información y material a Webcursos.</li>".'";'.
                                        "text += ".'"'."<li align = 'justify'> Los Usuarios deberán abstenerse de publicar cualquier material bibliográfico que no sea de libre acceso, que no sea de dominio público o que no haya sido extraído desde el catálogo de obras disponibles en la Biblioteca de la Universidad Adolfo Ibáñez. En el caso de realizar una publicación de aquellas obras disponibles en el catálogo la Biblioteca de la Universidad Adolfo Ibáñez, el material subido a la plataforma no podrá extenderse más allá del 15% del número total de sus páginas (Ejemplo: Si una obra tiene 100 páginas, deberán seleccionarse un máximo de 15 de ellas), o un capítulo completo del respectivo texto.</li>".'";'.
